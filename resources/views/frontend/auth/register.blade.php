...
<div class="wrapper-fixed">
    ...
    <form id="registration" method="post" action="register.php" class="has-validation-callback">
       <div class="form-bg">
          <div class="container ">
                   ...
                   <div class="">
                      ...
                      <div class="row">
                         <div class="col-sm-4 col-xs-12 form-group">
                            <div class="input">
                               <input type="text" maxlength="25" data-validation="required" name="reg_firstname" id="reg_firstname" placeholder="First name" value="">
                            </div>
                         </div>
                         <div class="col-sm-4 col-xs-12 form-group">
                            <div class="input">
                               <input type="text" maxlength="50" data-validation="required" name="reg_lastname" id="reg_lastname" placeholder="Last name" value="">
                            </div>
                         </div>
                         <div class="col-sm-4 col-xs-12 form-group">
                            <div class="input">
                   ...
                   <div class="form-group">
                      <div class="row">
                         <div class="col-sm-8 col-xs-12 form-group">
                            <div class="input">
                               <input type="text" maxlength="100" name="reg_company" id="reg_company" placeholder="Company Name (optional)" value="">
                            </div>
                         </div>
                         <div class="col-sm-4 col-xs-12 form-group">
                            <div class="input">
                               <input type="text" maxlength="20" name="reg_phone" id="reg_phone" data-validation="number" placeholder="Phone Number" value="">
                            </div>
                         </div>
                      </div>
                   </div>
                   ...
                   <div class="form-group">
                      ...
                      <div class="row">
                         <div class="col-sm-4 col-xs-12 form-group has-success">
                            <div class="input">
                               <input type="email" maxlength="50" name="reg_email" id="reg_email" data-validation="required" placeholder="Email address" value="" class="valid">
                            </div>
                         </div>
                         <div class="col-sm-4 col-xs-12 form-group has-success">
                            <div class="input">
                               <input type="password" name="reg_pass" id="reg_pass" data-validation="length,required" data-validation-length="min8" value="" placeholder="Password" class="valid">
                            </div>
                         </div>
                         <div class="col-sm-4 col-xs-12 form-group">
                            <div class="input">
                               <input type="password" name="reg_repass" id="reg_repass" data-validation="confirmation" data-validation-confirm="reg_pass" placeholder="Re-enter Password">
                            </div>
                         </div>
                      </div>
