                    ...
                    <div class="con-small frm">
                        ...
                        <div class="form-item">
                            <div class="note notepopup" style="display: none;">
                                ...
                                Please note that we have upgraded our system. Your registered Email will now be your login
                                ID. Please click on 'forgot password' to reset your password. We apologise for the
                            ...
                            <div class="">
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 form-group">
                                        <div class="input">
                                            <input type="email" data-validation="required" name="email" id="email"
                                    ...
                                    <div class="col-md-12 col-xs-12 form-group">
                                        <div class="input">
                                            <input type="password" data-validation="required" name="password" id="password"
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="input">
                                            ...
                                            <button type="button" class="join grey mb-3"
                                                onclick="window.location='{{ route('cart') }}'">
                                                CONTINUE AS GUEST
                                            </button>
