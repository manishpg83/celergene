    ...
    <header class="site-header mo-left header style-1 header-transparent">
            ...
            <nav class="nav navbar-expand-lg justify-content-end pb-2 pt-2">
              <ul class="navbar-nav align-items-center">
                <li class="nav-item pe-4">
                  <a class="nav-link bg-blue align-self-center text-white rounded-5 py-1 px-lg-3" aria-current="page"
                    href="blog.php">
                    Celergen's Blog
                  </a>
                </li>
      ...
      <a class="nav-link" aria-current="page" href="admin/blog-list.php">admin</a>
                ...
                <li class="nav-item pe-3">
                  <a class="nav-link" aria-current="page" href="https://www.facebook.com/CelergenSwiss" target="_blank">
                ...
                <li class="nav-item pe-3">
                  <a class="nav-link" aria-current="page" href="https://www.instagram.com/celergeneurope"
                    target="_blank">
                    <img
                      src="https://cdn2-bread6hkcwg3dyar.z01.azurefd.net/celergenswiss/images/common/ic_instagram.png"
                      alt="" class="src" />
                  </a>
                </li>

                <li class="nav-item pe-3">
                  <a class="nav-link" aria-current="page" href="https://twitter.com/CelergenSocial" target="_blank">
                ...
                <li class="nav-item">
                  <a class="nav-link pe-0" aria-current="page" href="https://celergenswiss.com/th/" target="_blank">
                    <img src="https://cdn2-bread6hkcwg3dyar.z01.azurefd.net/celergenswiss/images/common/Thai.png" alt=""
                      class="" />
                  </a>
                </li>
              </ul>
            ...
            <nav class="navbar nav navbar-expand-lg justify-content-end py-1 py-md-2">
              ...
              <div class="container-fluid pe-0 pt-1 justify-content-between d-block d-lg-none">
                <div class="navbar nav py-0">
                  <div>
                    <a href="https://celergenswiss.azurewebsites.net/"><img id="headerlogo1" class="expand-logo"
                        src="https://cdn2-bread6hkcwg3dyar.z01.azurefd.net/celergenswiss/images/common/cropped-celergen-logo.png"
                  ...
                  <div class="align-items-end">
                    <ul class="navbar-nav flex-row">
                      ...
                      <li class="nav-item">
                        <a class="navbar-toggler p-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
                          aria-controls="offcanvasNavbar" style="border: none">
                          <img
                            src="https://cdn2-bread6hkcwg3dyar.z01.azurefd.net/celergenswiss/images/common/ic_burger.png"
              ...
              <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="mobile-menubar">
                  ...
                  <ul class="navbar-nav justify-content-end sidbar-main-menu text-end">
                    ...
                    <li class="nav-item mx-xl-2 mx-lg-0 py-xl-2 dropdown menu-item-has-children sidbar-main-item">
                      <a id="main-menu1" onclick="toggleClass1()" class="nav-link px-xl-3 px-lg-2 dropdown text-blue"
                        href="#">
                        <span id="plusicon1"
                    ...
                    <li
                      ...
                      <a id="main-menu2" onclick="toggleClass2()" class="nav-link px-xl-3 px-lg-2 dropdown" href="#">
                        <span id="plusicon2"
                          class="fa fa-plus d-lg-none bg-blue text-white p-1 me-2 float-start"></span>
                        BENEFITS
                      </a>
                    ...
                    <li
                      class="nav-item mx-xl-2 mx-lg-0 py-xl-2 dropdown dropdown menu-item-has-children sidbar-main-item">
                      <a id="main-menu3" onclick="toggleClass3()" class="nav-link px-xl-3 px-lg-2 dropdown" href="#">
                        <span id="plusicon3"
                          class="fa fa-plus d-lg-none bg-blue text-white p-1 me-2 float-start"></span>
                        SUCCESS STORIES
                      </a>
                    ...
                    <li class="nav-item mx-xl-2 mx-lg-0 py-xl-2 dropdown dropdown">
                      <a class="nav-link px-xl-4 px-lg-2 dropdown" href="https://store.celergenswiss.com/cart.php">
                        ORDER HERE
                      </a>
                    </li>

                    <li class="nav-item ms-xl-2 mx-lg-0 py-2 dropdown d-lg-block d-none position-relative">
                    ...
                    <li class="nav-item mx-xl-2 mx-lg-0 py-xl-2 dropdown d-lg-none d-md-block dropdown">
                    ...
                    <ul id="mobile-social" class="p-0 m-0 float-end">
                      <li class="p-2 d-inline">
                        <a href="https://twitter.com/CelergenSocial" target="_blank"><img
                            ...
                            width="20px" alt="Celergen Switzerland Twitter" class="twitter" /></a>
                      </li>
                      <li class="p-2 d-inline">
                        <a href="https://www.instagram.com/celergeneurope" target="_blank"><img
                            ...
                            width="20px" alt="Celergen Switzerland Instagram" class="twitter" /></a>
                      </li>
                      <li class="p-2 d-inline">
                        <a href="https://www.facebook.com/CelergenSwiss" target="_blank"><img
                            ...
                            width="20px" alt="Celergen Switzerland Facebook" class="facebook" /></a>
                      </li>
                    </ul>
                  </div>
                </div>
