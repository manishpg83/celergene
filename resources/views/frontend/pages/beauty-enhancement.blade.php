                                ...
                                <div class="owl-item active" style="width: 930px; margin-right: 60px;">
                                    <div class="item benefits-item">
                                        <div class="item-shadow">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <img src="{{ asset('frontend/images/benefits/Dr.-Rene.jpg') }}"
                                ...
                                <div class="owl-item" style="width: 930px; margin-right: 60px;">
                                    <div class="item benefits-item">
                                        <div class="item-shadow">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <img src="{{ asset('frontend/images/benefits/Dr.-Thomas-Tzikas.jpg') }}"
                                                        alt="" class="imag-frame">
                                                </div>
                                                <div class="col-lg-9">
                                                    <h5
                                ...
                                <div class="owl-item" style="width: 930px; margin-right: 60px;">
                                    <div class="item benefits-item">
                                        <div class="item-shadow">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <img src="{{ asset('frontend/images/benefits/Dr.-Eleana-Papacharalambous.jpg') }}"
                                                        alt="" class="imag-frame">
                                                </div>
                                                <div class="col-lg-9">
                                                    <h5
