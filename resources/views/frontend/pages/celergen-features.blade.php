...
<section class="margin-top">
    <div class="container-fluid px-0">
       <div class="CallunaRegular padding-x bg-blue text-white">
          <h1 class="text-white section-heading CallunaRegular border-left m-0"> CELERGEN FEATURES </h1>
       </div>
    </div>
 </section>

 <section>
    <div class="container-fluid px-0 celergen-features mb-lg-5">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular">2014 - 2016</h4>
          <h1 class="section-heading text-blue CallunaRegular">TOWN &amp; COUNTRY</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0">
          <div class="container">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2016 </h4>
          <h1 class="section-heading text-blue CallunaRegular">UK TATLER</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
             <div class="col-lg-10 mx-auto">
                <div class="row d-flex justify-content-center pt-lg-2">
                   <div class="col-xl-3 col-lg-4 col-sm-6 col-6 mb-3">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2016 </h4>
          <h1 class="section-heading text-blue CallunaRegular">ROBB REPORT US</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
             <div class="col-lg-10 mx-auto">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2016 </h4>
          <h1 class="section-heading text-blue CallunaRegular">VANITY FAIR UK</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
             <div class="col-lg-10 mx-auto">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3 ">
          <h4 class="text-blue CallunaRegular"> 2015 </h4>
          <h1 class="section-heading text-blue CallunaRegular">ROBB REPORT US</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2014 </h4>
          <h1 class="section-heading text-blue CallunaRegular">ROBB REPORT US</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2014 </h4>
          <h1 class="section-heading text-blue CallunaRegular">DUPONT REGISTRY</h1>
       </div>
       <div class="paddiny top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
             <div class="col-lg-10 mx-auto">
                <div class="row d-flex justify-content-center pt-lg-2">
                   <div class="col-xl-3 col-lg-4 col-sm-6 col-6 mb-3">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2014 </h4>
          <h1 class="section-heading text-blue CallunaRegular">JET SET &amp; HERITAGE</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
             <div class="col-lg-10 mx-auto">
 ...
 <section>
    <div class="container-fluid px-0 celergen-features border">
       <div class="container padding-x text-center py-lg-4 py-3">
          <h4 class="text-blue CallunaRegular"> 2013, 2012 </h4>
          <h1 class="section-heading text-blue CallunaRegular">ROBB REPORT US</h1>
       </div>
       <div class="padding-y top-shadow text-center position-relative px-0 mb-lg-5">
          <div class="container">
