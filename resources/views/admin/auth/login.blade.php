            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-6">
                <a href="index.html" class="app-brand-link">
                  <span class="app-brand-text demo text-heading fw-bold"></span><img src="{{ asset('admin/assets/img/branding/Celergen-Logo.png') }}" alt="Celergen Swiss" width="auto" height="40">
                </a>
              </div>
              <!-- /Logo -->
