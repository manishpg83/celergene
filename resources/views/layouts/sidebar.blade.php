<div x-data="{ open: false }"
     class="flex h-screen bg-white border-r transition-all duration-300 ease-in-out"
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <nav class="flex-1 px-2 py-4 space-y-2">
            <a href="#" class="flex items-center px-4 py-2 text-gray-700 hover:bg-purple-100 rounded-md">
            ...
            <a href="#" class="flex items-center px-4 py-2 text-gray-700 hover:bg-purple-100 rounded-md">
                <svg class="h-6 w-6 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="ml-3" x-show="open">Add Vendor</span>
            </a>
