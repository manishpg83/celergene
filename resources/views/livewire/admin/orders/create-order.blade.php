                    ...
                    <form wire:submit.prevent="submitOrder">
                            ...
                            <div class="col-12">
                                ...
                                @foreach ($orderDetails as $index => $orderDetail)
                                    <div class="row align-items-end mt-0 g-2">
                                        ...
                                        <div class="col-md-1">
                                            <button wire:click.prevent="removeOrderDetail({{ $index }})" class="btn btn-danger btn-sm">Remove</button>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <div class="row g-3 mt-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" wire:model.live="tax" id="tax" class="form-control @error('tax') is-invalid @enderror" min="0" step="0.01">
                                @error('tax')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
