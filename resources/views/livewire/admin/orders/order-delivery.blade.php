                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select wire:model="deliveryStatus" id="deliveryStatus" class="form-control">
                                    <option value="Pending">Pending</option>
                                    <option value="Shipped">Shipped</option>
                                    <option value="Delivered">Delivered</option>
                                    <option value="Cancelled">Cancelled</option>
                                </select>
                                @error('deliveryStatus') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td class="text-center">
                                        @foreach ($detail->product->inventories as $inventory)
                                            <div class="mb-3 p-2 border rounded">
                                                ...
                                                <input type="number" 
                                                       wire:model="inventoryQuantities.{{ $inventory->id }}"
                                                       class="form-control"
                                                       min="0"
