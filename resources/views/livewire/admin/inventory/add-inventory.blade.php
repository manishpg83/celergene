            ...
            <div class="card">
                <div
                    ...
                    <h5 class="card-title mb-sm-0 me-2">
                        {{ $isEditMode ? 'Edit Inventory' : 'Add Inventory for New Batch' }}</h5>
                    ...
                    <div class="row">
                            ...
                            <form wire:submit.prevent="saveInventory" class="mt-2 row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" wire:model="quantity" id="quantity" class="form-control"
                                        placeholder="Enter quantity" required value="{{ $quantity ?? 0 }}">
                                    @error('quantity')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            @if ($isEditMode)
                                <div class="mt-2 row">
                                    <form wire:submit.prevent="transferStock">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="transfer_quantity">Quantity to
                                                Transfer</label>
                                            <input type="number" wire:model="transfer_quantity"
                                                id="transfer_quantity" class="form-control"
                        ...
                        <div class="mt-5">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="mb-0 fw-bold text-primary">📦 Inventory History</h5>

                                <!-- Your preferred export button design -->
                            ...
                            <div
                                ...
                                <span class="fs-5 fw-bold text-primary">Delivery Order:
