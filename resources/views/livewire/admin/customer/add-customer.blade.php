                                ...
                                <div class="mt-6 mb-4 card">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3" @if ($sameAsBilling) wire:ignore @endif>
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_phone_1">Contact Number
                                                    1</label>
                                                <input type="text" wire:model="shipping_phone_1"
                                                    class="form-control" id="shipping_phone_1">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_company_name_1">Shipping
                                                    Company Name 1</label>
                                                <input type="text" wire:model="shipping_company_name_1"
                                                    class="form-control" id="shipping_company_name_1">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 mb-4 card">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_phone_2">Contact Number
                                                    2</label>
                                                <input type="text" wire:model="shipping_phone_2"
                                                    class="form-control" id="shipping_phone_2">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_company_name_2">Shipping
                                                    Company Name 2</label>
                                                <input type="text" wire:model="shipping_company_name_2"
                                                    class="form-control" id="shipping_company_name_2">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 mb-4 card">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_phone_3">Contact Number
                                                    3</label>
                                                <input type="text" wire:model="shipping_phone_3"
                                                    class="form-control" id="shipping_phone_3">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="shipping_company_name_3">Shipping
                                                    Company Name 3</label>
                                                <input type="text" wire:model="shipping_company_name_3"
                                                    class="form-control" id="shipping_company_name_3">
                                            </div>
                                        </div>
                                    </div>
                                </div>
