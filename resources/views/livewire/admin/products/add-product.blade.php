                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mx-auto col-lg-10">
                            <form wire:submit.prevent="submit" class="mt-2 row g-3" enctype="multipart/form-data">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="invoice_description"
                                        wire:model="invoice_description" placeholder="Enter product Invoice Description"
                                        required></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="bg-transparent d-flex align-items-center ps-2" style="height: 38px;">
                                        <div class="mb-0 form-check">
                                            <input type="checkbox" class="form-check-input" id="is_online"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="remarks_notes" wire:model="remarks_notes"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-2">
                                        @if ($product_img && $product_img instanceof \Livewire\TemporaryUploadedFile)
                                            <img src="{{ $product_img->temporaryUrl() }}" alt="Preview"
                                                class="img-thumbnail" style="max-height: 150px;">
                                        @elseif ($isEditMode && $product_img_url)
                                            <img src="{{ asset($product_img_url) }}" alt="Existing Image"
                                                class="img-thumbnail" style="max-height: 150px;">
                                        @endif
                                    </div>
