<div class="container-xxl flex-grow-1 container-p-y">
    <div
        ...
        <div class="d-flex flex-column justify-content-center">
            <h4 class="mb-1 ml-2 text-2xl">Product List</h4>
        </div>
                                ...
                                <tr class="text-center {{ $product->trashed() ? 'table-warning' : '' }}">
                                    ...
                                    <td class="text-center">
                                        <div class="gap-2 d-flex align-items-center justify-content-center">
                                            <a href="{{ route('admin.products.details', $product->id) }}" class="text-black"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="actionMenu{{ $product->id }}">
                                                    <li><a class="dropdown-item" wire:click="edit({{ $product->id }})"
