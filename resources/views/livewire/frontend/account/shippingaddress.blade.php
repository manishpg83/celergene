        ...
        <div class="col-md-6 m-b30">
            <div class="address-card">
                ...
                <div class="account-address-bottom">                                
                    <a href="account-billing-address.html" class="d-block me-3"><i class="fa-solid fa-pen me-2"></i>Edit</a>                                
                    <a href="javascript:void(0);" class="d-block me-3"><i class="fa-solid fa-trash-can me-2"></i>Remove</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 m-b30">
            <div class="address-card">
                ...
                <div class="account-address-bottom">                                
                    <a href="account-shipping-address.html" class="d-block me-3"><i class="fa-solid fa-pen me-2"></i>Edit</a>                                
                    <a href="javascript:void(0);" class="d-block me-3"><i class="fa-solid fa-trash-can me-2"></i>Remove</a>                                
                </div>
            </div>
        </div>
