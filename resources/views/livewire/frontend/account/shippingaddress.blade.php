            ...
            <div class="col-md-4 m-b30">
                <div class="address-card">
                    <div class="account-address-box">
                        <h6 class="mb-3">{{ $address['title'] }}</h6>
                        <ul>
                            <li>{{ $address['name'] }}</li>
                    ...
                    <div class="account-address-bottom">
                        <a href="{{ route('addshippingaddress', ['addressNumber' => $address['id']]) }}"
                            class="d-block me-3">
                            <i class="fa-solid fa-pen me-2"></i>Edit
                        </a>
                        <a href="javascript:void(0);" wire:click="confirmDelete({{ $address['id'] }})" class="d-block me-3">
        ...
        @if($canAddMore)
            <div class="col-12">
                <div class="account-card-add">
                    ...
                    <a class="px-5 btn btn-primary" href="{{ route('addshippingaddress') }}">Add</a>
                </div>
            </div>
        @endif
    </div>
